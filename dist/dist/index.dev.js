...
function () {
  ...
  */
  ...
  IBL.prototype.autopost = function (interval) {
    return __awaiter(this, void 0, Promise, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (!interval) interval = 1800000; //30 minutes in milliseconds
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4
            /*yield*/
            , axios_1["default"].post(this.base_url + "/bot/" + this.client.user.id, {
  ...
  IBL.prototype.TestClient = function (client) {
    if (client instanceof discord_js_1.Client) return "djs";else if (client instanceof eris_1.Client) return "eris";else throw new TypeError("Unfortunately this package only supports the discord.js or eris discord libraries.");
  };
